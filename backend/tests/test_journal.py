...
# NOTE: the round-2 client-trust scale-out test (asserting realized accumulates
# the CLIENT-supplied values) was removed in R3-WS1 — the server now RECOMPUTES
# each slice from the live mark and ignores client realized_pnl. The structural
# leg-reduction + qty>=held rejection it covered now live in the recompute-aware
# test_scale_out_accumulates_across_two_slices / _rejects_qty_at_or_above_held.
